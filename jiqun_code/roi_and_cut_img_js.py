...
if __name__ == '__main__':
    ...
    defect_nums = {"heixian": 0, "fushidian": 0, "huichen": 0, "zangwu": 0, "ignore": 0}

    # path需包含img和json
    path = '/data/home/jiachen/data/seg_data/kesen/0524/data/heixian/yinbaise'
    save_dir = os.path.join(path, 'cuted_dir')
    mkdir(save_dir)
    ...
    if flag == 1:
        ...
        cuted_dir = '/data/home/jiachen/data/seg_data/kesen/0524/data/heixian/yinbaise/cuted_dir/data/heixian/yinbaise'
