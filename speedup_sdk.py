...
def diangui(diangui_area_distance, boxes, areas):
    ...
    area_large, area2_med, area_small, dis50 = diangui_area_distance[:4]
    num_large, num_small = diangui_area_distance[4:]
...
def sdk_fun(onnx_path, img_full_path, roi, res_dir):
    ...
    cv_imwrite(full_, os.path.join(res_dir, name+'.jpg'))