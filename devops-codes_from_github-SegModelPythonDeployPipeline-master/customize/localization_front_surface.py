...
if __name__ == "__main__":
    ...
    # # 分时频闪明场 debug
    dir_image = r"D:\Work\projects\kersen\test\loc_test\bar"
    dir_out = r"D:\Work\projects\kersen\test\loc_test\bar_output"
    func = localize_for_front_surface_Bar
    ...
    for root, dirs, files in os.walk(dir_image):
        for file in files:
            if is_image(file):
                ...
                left, top, right, bottom = func(source_image, expend=200)
