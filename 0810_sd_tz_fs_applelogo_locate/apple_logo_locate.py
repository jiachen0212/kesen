...
if __name__ == "__main__":
    ...
    # tongzhou 
    # image_path = r'D:\work\project\DL\kesen\data\tz.bmp'
    ...
    # image_path = r'D:\work\project\beijing\Smartmore\2022\DL\kesen\codes\apple_logo_locate\fs.jpg'
    # image = np.asarray(Image.open(image_path))
    # roi = (2900, 2000, 14000, 20600)
    ...
    # suidao 右半张图
    tz_image = cv2.imread(r'D:\work\project\DL\kesen\data\sd.bmp')
